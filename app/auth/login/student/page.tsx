      ...
      <main className="relative z-10 pt-24 md:pt-32 pb-16 px-4 md:px-8">
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <div className="bg-gray-800/20 backdrop-blur-sm rounded-xl p-4 border border-gray-700/30 text-center">
            ...
            <div className="bg-gray-800/20 backdrop-blur-sm rounded-xl p-4 border border-gray-700/30 text-center">
              ...
              <p className="text-gray-400 text-sm">24/7 Help Desk</p>
            </div>
          </div>

          {/* Security Notice */}
          <div className="mt-4 bg-gray-800/20 backdrop-blur-sm rounded-xl p-4 border border-gray-700/30">
